...
function htmlContent(el1,el2,el3,ind){
    return `<li date-index = ${ind}>${el1} - ${el2}€ - ${el3} <span class="delButton" id=${ind}>❌</span></li>`
...
function displayListe(){
    ...
    tabListe.forEach((e,index) =>{
        liste.innerHTML += htmlContent(e[0],e[1],e[2],index);
    })
